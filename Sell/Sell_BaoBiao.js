...
export default class BaoBiao extends Component {
    ...
    pressPop(){
        if(this.state.BBName=="总交易报表"){
            ...
            dbAdapter.selectSingleProd(this.state.startDate, this.state.endDate).then((rows) => {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.Content}>
                    <TouchableOpacity style={styles.ContList} onPress={(data)=>{this.showDatePicker(true)}}>
                    ...
                    <TouchableOpacity style={styles.ContList}  onPress={(data)=>{this.showDatePicker(false)}}>
                        <Text style={styles.ContLeft}>结束日期</Text>
                        <Text style={styles.ContRight}>{this.state.Edate.toString()}</Text>
                        <DatePicker theme="3" ref={(picker)=>{this.picker=picker}}/>
                    </TouchableOpacity>
                    <View style={[styles.Row,{marginLeft:15,marginRight:15}]}>
                        <TouchableOpacity style={[styles.button,{marginRight:15,}]} onPress={this.pressPop.bind(this)}>
