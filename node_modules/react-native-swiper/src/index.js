...
export default class extends Component {
  ...
  renderNextButton = () => {
    ...
    // if (this.props.loop ||
    //   this.state.index !== this.state.total - 1) {
    //   button = this.props.nextButton || <View style={styles.Left}><Text style={styles.buttonText}>›</Text></View>
    // }
  ...
  renderPrevButton = () => {
    ...
    //   button = this.props.prevButton || <View style={styles.Left}><Text style={styles.buttonText}>‹</Text></View>
    // }
